...
export default function Home() {
  ...
  return (
    <div>
      <Head>
        <title>BMSIT PBL 2023</title>
        <meta name="description" content="Whitelist-Dapp" />
        <link rel="icon" href="/favicon.ico" />
      </Head>
      <div className={styles.main}>
        <div>
          <h1 className={styles.title}>Mint your nft as token of appreciation</h1>
          <div className={styles.description}>
          if amount donated is greater than 500$ nft can be minted 	
&#129304;&#128640;.
          </div>
          <div className={styles.description}>
          ...
          <br></br>
          <>
          minted nft can be viewed in opensea testnet<br></br>
